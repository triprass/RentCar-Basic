...
session_start();
    if (isset($_POST['simpan_edit'])) {
        ...
        if ($edit_pengguna and $simpan_aktivitas) {
            ...
            header("Location:../../dist/index.php?page=pengguna&edit=berhasil");
        }
        else {
            mysqli_query($kon,"ROLLBACK");
            header("Location:../../dist/index.php?page=pengguna&edit=gagal");
    ...
    $status=$data['status'];
?>
<form action="pengguna/edit-pengguna.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php
                    $daftar_level = array("Super Admin","Admin", "Manajer");
                    for ($i=0;$i<3;$i++):
                ?>
    ...
    <br>
    <button type="submit" name="simpan_edit" id="btn-pengguna" class="btn btn-dark" >Update Pengguna</button>
</form>
