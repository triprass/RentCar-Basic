...
session_start();
    if (isset($_POST['simpan_tambah'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $log_aktivitas="Tambah pengguna #$kode_pengguna ";
            ...
            if ($simpan_pengguna and $simpan_aktivitas) {
                ...
                header("Location:../../dist/index.php?page=pengguna&add=berhasil");
            }
            else {
                mysqli_query($kon,"ROLLBACK");
                header("Location:../../dist/index.php?page=pengguna&add=gagal");
            }
...
?>
<form action="pengguna/tambah-pengguna.php" method="post" enctype="multipart/form-data">
    ...
    <button type="submit" name="simpan_tambah" id="btn-pengguna" class="btn btn-dark" disabled >Tambah</button>
</form>
