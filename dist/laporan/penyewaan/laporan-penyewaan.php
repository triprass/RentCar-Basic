...
<script>
    $('title').text('Laporan Penyewaan');
</script>
<main>
    <div class="container-fluid">
        <h2 class="mt-4">Laporan Penyewaan</h2>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Daftar Laporan Penyewaan</li>
        </ol>
...
<script>
    ...
    $('#btn-tampil').on('click',function(){
        ...
        var data = $('#form').serialize();
            $.ajax({
                type	: 'POST',
                url: 'laporan/penyewaan/tampil-penyewaan.php',
                data: data,
                cache	: false,
